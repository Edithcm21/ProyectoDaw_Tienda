...
<head>
    ...
    <script src="https://kit.fontawesome.com/9c7135bd50.js" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.1.3/dist/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">

</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="#">LUYED Store</a>
...
<li class="nav var-item">
    <a style="margin-left: 10px; border: none;" class="btn btn-outline-ligth" href="views/imagen.jsp">imagen</a>
</li>
